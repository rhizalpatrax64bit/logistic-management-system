...
{
    public partial class FormVIEWKOTA : Form
    {
        ...
        public FormVIEWKOTA(DELIVERYORDER.FormDATAENTRY _frm, string namaField,int _type)
        {
            InitializeComponent();
        ...
        private void FormVIEWKOTA_KeyUp(object sender, KeyEventArgs e)
        {
        ...
        private void dgvKOTA_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void FormVIEWKOTA_Load(object sender, EventArgs e)
        {
            txtCARI.Focus();
        }
